...
const SubmitPage = () => {
  ...
  // Retrieve user_id from localStorage or set it to null if not found
  const userId = localStorage.getItem('user_id') && localStorage.getItem('user_id') !== 'undefined'
  ...
  const handleSubmit = async (e) => {
    ...
    const bookingData = {
      ...
      state,
      country,
      date: currentDate, // Pass the current date to the API
    };
    ...
    try {
      ...
      const result = await response.json(); // Store response data in `result`
