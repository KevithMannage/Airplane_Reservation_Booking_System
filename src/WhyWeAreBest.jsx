// src/components/WhyWeAreBest.jsx

import React, { useState } from 'react';
import './WhyWeAreBest.css'; // Import CSS for styling
...
const WhyWeAreBest = () => {
  ...
  return (
    <div className="why-best-section">
      ...
      {/* Container for Accordion and Image */}
      <div className="content-container">
        ...
        <div className="airline-logo">
          <img src="/6.jpg" alt="Airline Logo" /> {/* Replace with actual logo path */}
